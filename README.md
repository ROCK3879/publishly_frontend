...
The first section of this documentation provides a detailed description of Admin Stories, followed by comprehensive documentation on the User Stories.
...
This green button is available on the users’ page, allowing admins to view and update user information efficiently. It serves as a quick and intuitive way to manage individual user details.

![View/Update Info Button](src/images/2.0.users_page_view_update_info_green_button.jpg)

#### Update Platform Button

This button enables admins to update platform-specific information for users. It is essential for ensuring that user data remains consistent and up-to-date across all relevant systems or platforms.

![Update Platform Button](src/images/2.1.user_page_update_platform.jpg)
